...
[t,Z]=ode15s(@(t,Z)odefun2(t,Z,u,y,y_dot,gamma),[0 :0.0001 :20],[0;0;0.2;0.2;0.2]);
...
function dZ=odefun2(t,Z,u,y,y_dot,gamma)
    x = Z(1:2);
    theta = Z(3:5);
    dx=[y_dot(t)+2*(y(t)-x(1));-theta(1)*y_dot(t)-theta(2)*y(t)+theta(3)*2.5*sin(t)+2*(y_dot(t)-x(2))];
    dtheta(1)=-gamma(1)*(y_dot(t)-x(2))*y_dot(t);
    dtheta(2)=-gamma(2)*(y_dot(t)-x(2))*y(t);

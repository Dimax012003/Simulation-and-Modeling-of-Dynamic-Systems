...
gamma=[16000,15000,30000,1200];

[t,z]=ode15s(@(t,Z)odefun2(t,Z,x1,x2,u,gamma),[0:0.001:20],[0;0;0.01;0.01;0.25;0.01]);
...
function dZ=odefun2(t,Z,x1,x2,u,gamma)
    x=Z(1:2);
    theta=Z(3:6);
    dx=[x2(t)+100*(x1(t)-x(1));-theta(1)*x2(t)-theta(2)*sin(x1(t))+theta(3)*x2(t)^2*sin(2*x1(t))+theta(4)*u(t)+100*(x2(t)-x(2))];
